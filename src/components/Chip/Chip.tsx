...
interface ChipProps {head?: string, content: string, close: boolean}

const Chip: FC<ChipProps> = ({head, content, close}) => (
  <div data-testid="Chip">
      <div className={styles.chip}>
          {head && <div className="chip-head">{head}</div>}
          <div className="chip-content">{content}</div>
          {close && <div className="chip-close">
